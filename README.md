...
- Dataset: day.csv file


<!-- You don't have to answer all the questions - just the ones relevant to your project. -->

## Conclusions
- Temparature is highly correlated with the demand.
- Demand for bike rentals are high in Fall and Summer seasons.
- Bike rentals are more on non-holidays.
- Demand for bike rentals is increased in second year(2019) when compared to the first year(2018).
